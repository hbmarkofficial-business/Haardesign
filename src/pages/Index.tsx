  ...
  return (
    <>
      <Helmet>
        ...
        <title>Friseursalon Bielefeld | Haardesign</title>
        <meta
          name="description"
          content="Besuche unseren Premium Friseursalon Haardesign in Bielefeld für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Haardesign | Premium Friseursalon Bielefeld" />
        <meta
        ...
        <meta name="twitter:title" content="Haardesign | Premium Friseursalon Bielefeld" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "sameAs": [
              "https://www.facebook.com/haardesign",
              "https://www.instagram.com/haardesign"
            ]
          })}
        </script>
      </Helmet>
